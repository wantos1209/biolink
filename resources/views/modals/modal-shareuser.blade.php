...
<div id="showshareuser" class="sec_modal" >
...
{{-- <div class="profilcontainer"> --}}
    <div class="formprofil bg-white ">
        ...
        <div class="mt-26">    
            <div class="list_input align-center">
                    ...
                    <div class="share-social">
                        <div class="share-wa">
                            <div class="flexbetween px-24 h-48 xs:h-64 hover:bg-gray-100 cursor-pointer full-modal relative target-modal">
        ...
        <div class="mt-26 text-20 text-gradient align-center" >
            <span id="copyText" class="hover:underline">{{ config('app.APP_URL') .  '/' . $username  }}</span>
        </div>
        <div class="h-60">
            ...
            <p id="copySuccess" style="display:none; color:green; text-align:center;">Link berhasil disalin!</p> 
        </div>
    </div>
</div>
{{-- </div> --}}
